...
def gt():
    ...
    input_path = os.path.join(base_dir, "../dataset/0409/gt/anchor3.csv")
    ...
    output_path = os.path.join(base_dir, "../dataset/0409/gt/anchor3-processed.csv")
...
def beacons():
    ...
    # Read the input CSV file
    input_path = os.path.join(base_dir, "../dataset/0409/beacons/anchor3.csv")
    output_path = os.path.join(base_dir, "../dataset/0409/beacons/anchor3-processed.csv")
