...
if __name__ == '__main__':
    ...
    # Load files
    gt_path = os.path.join(base_dir, "../dataset/mobility/gt/use-case3/gt_mobility_use-case3_run2.csv")
    gt_df = pd.read_csv(gt_path)

    ms_path = os.path.join(base_dir, "../dataset/mobility/beacons/use-case3/beacons_mobility_use-case3_run2.csv")
